...
class courtDataset(Dataset):
    ...
    def __init__(self, mode, input_height=720, input_width=1280, scale=4.2, hp_radius=55):
    ...
    def __getitem__(self, index):
        img_name = self.data[index]['id'] + '.jpg'
        ...
        x_ct, y_ct = line_intersection((kps[0][0], kps[0][1], kps[2][0], kps[2][1]),  # top-left to bottom-right
                                        (kps[1][0], kps[1][1], kps[3][0], kps[3][1]))  # top-right to bottom-left
